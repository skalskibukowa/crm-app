    ...
    <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
      <div className="flex flex-wrap justify-between items-center">
        <div className="flex justify-start items-center">
          ...
          <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
           <path fill="#F1C21B" d="M43.6,-67.1C51.8,-62.5,50.6,-42.6,51.4,-27.4C52.2,-12.3,54.9,-2,56.7,10.4C58.5,22.9,59.3,37.5,51.7,43.1C44.2,48.7,28.2,45.3,15.1,47.4C1.9,49.5,-8.5,57.1,-18,56.5C-27.5,55.9,-35.9,47.2,-47.2,38.5C-58.5,29.8,-72.7,21.1,-75.5,10.1C-78.4,-1,-69.9,-14.5,-61.5,-26.1C-53.2,-37.7,-45,-47.5,-34.7,-51.1C-24.5,-54.8,-12.2,-52.5,2.7,-56.7C17.7,-61,35.4,-71.7,43.6,-67.1Z" transform="translate(100 100)" />
            ...
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">CRM SYSTEM</span>
          </a>
        ...
        <div className="flex items-center lg:order-2">
          ...
          {/* <!-- Dropdown menu --> */}
          <div
            className="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded-xl divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl"
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4 p-4">
              ...
              >
                <svg
                  aria-hidden="true"
                  className="mx-auto mb-1 w-7 h-7 text-gray-400 group-hovestrokeLinecapr:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"

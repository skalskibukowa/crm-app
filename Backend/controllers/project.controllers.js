...
const getAllProject = async (req, res, next) => {
    try {
        ...
        return res.status(200).json({ message: 'Success!', projectDetails: projects });
    } catch (err) {
        return res.status(500).json({ message: 'Fetching projects failed, please try again later.' });
    }
};
...
const getProject = async (req, res, next) => {
    try {
        ...
        return res.status(200).json({ message: 'Success!', project: projectDetails });
    } catch (err) {
...
const updateProject = async (req, res, next) => {
    try {
        ...
        return res.status(200).json({ message: 'Project has been updated', project: projectUpdate });
    } catch (err) {
        return res.status(500).json({ message: 'Something went wrong, try again later!' });
    }
};
...
const deleteProject = async (req, res, next) => {
    try {
        ...
        return res.status(200).json({ message: 'Success! Project has been removed!', project: deleteProject });
    } catch (err) {
        return res.status(500).json({ message: 'Something went wrong, try again later!' });
    }
};
...
const createProject = async (req, res, next) => {
    ...
    const { projectName, projectImage ,clientName ,address, industries, size, contactPerson,  AssignedUser } = req.body;
    ...
    try {
      ...
      console.error(err);
      return res.status(500).json({ message: 'Creating project failed, please try again.' });
    }
  };
